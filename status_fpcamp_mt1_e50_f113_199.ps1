# status_fpcamp_mt1_e50_f113_199.ps1 -- READ-ONLY status probe.  Starts nothing.
#   ssh USER@HOST_199 "powershell -NoProfile -ExecutionPolicy Bypass -File C:\Users\USER\lpopt_work\kit_frontier\status_fpcamp_mt1_e50_f113_199.ps1"
$ErrorActionPreference = 'SilentlyContinue'
$k   = 'C:\Users\USER\lpopt_work\kit_frontier'
$r   = Join-Path $k 'runs\fpcamp_mt1_e50_f113'
$log = Join-Path $k 'fpcamp_mt1_e50_f113_out.log'
$rcf = Join-Path $k 'fpcamp_mt1_e50_f113_rc.txt'
