# status_fpcamp_E1E2_f109_199.ps1 -- READ-ONLY status probe for the E1_E2/f109
# low-feed opening campaign.  Emits a machine-parsable block; starts nothing.
#   ssh USER@HOST_199 "powershell -NoProfile -ExecutionPolicy Bypass -File C:\Users\USER\lpopt_work\kit_frontier\status_fpcamp_E1E2_f109_199.ps1"
$ErrorActionPreference = 'SilentlyContinue'
$k   = 'C:\Users\USER\lpopt_work\kit_frontier'
$r   = Join-Path $k 'runs\fpcamp_minfr_E1E2_f109'
$log = Join-Path $k 'fpcamp_minfr_E1E2_f109_out.log'
$rcf = Join-Path $k 'fpcamp_minfr_E1E2_f109_rc.txt'
