# status_fpcamp_TRIPLE_f125_r2_199.ps1 -- READ-ONLY status probe for the
# ROUND-2 3-fresh-type (graded) campaign at feed 125. Emits a machine-parsable
# block; starts nothing.
#   ssh USER@HOST_199 "powershell -NoProfile -ExecutionPolicy Bypass -File C:\Users\USER\lpopt_work\kit_frontier\status_fpcamp_TRIPLE_f125_r2_199.ps1"
$ErrorActionPreference = 'SilentlyContinue'
$k   = 'C:\Users\USER\lpopt_work\kit_frontier'
$r   = Join-Path $k 'runs\fpcamp_minfr_triple_f125_r2'
$log = Join-Path $k 'fpcamp_minfr_triple_f125_r2_out.log'
$rcf = Join-Path $k 'fpcamp_minfr_triple_f125_r2_rc.txt'
