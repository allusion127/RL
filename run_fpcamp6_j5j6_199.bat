...
REM   measured numbers and the knob audit are in fpcamp6_j5j6_199.inp's header.
REM
...
REM  6  fpcamp6_j5j6_199.inp                      YES
...
REM         --input fpcamp6_j5j6_199.inp
...
"%PY%" -u -m lpopt optimize --input fpcamp6_j5j6_199.inp --run-dir runs/fpcamp6_j5j6 --no-early-stop > fpcamp6_j5j6_199_out.log 2>&1
echo %ERRORLEVEL% > fpcamp6_j5j6_199_rc.txt
endlocal
