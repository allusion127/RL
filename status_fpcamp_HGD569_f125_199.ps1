# status_fpcamp_HGD569_f125_199.ps1 -- READ-ONLY status probe for the high-Gd
# boron-opened-cell F_r assault, feed-125 pivot.  Emits a machine-parsable
# block; starts nothing.
#   ssh USER@HOST_199 "powershell -NoProfile -ExecutionPolicy Bypass -File C:\Users\USER\lpopt_work\kit_frontier\status_fpcamp_HGD569_f125_199.ps1"
$ErrorActionPreference = 'SilentlyContinue'
$k   = 'C:\Users\USER\lpopt_work\kit_frontier'
$r   = Join-Path $k 'runs\fpcamp_minfr_hgd569_f125'
$log = Join-Path $k 'fpcamp_minfr_hgd569_f125_out.log'
$rcf = Join-Path $k 'fpcamp_minfr_hgd569_f125_rc.txt'
