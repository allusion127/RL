"""ARM 2b -- byte-copy of ``fxy_gate_eval_arm2_20260829.py`` with ONLY ``OUT``
changed, re-run through the FIXED serve path (``featurize.serve_provenance``,
2026-08-29 train/serve forensic).  INFORMATIONAL: this is not a re-adjudication.
...
nothing, edits no deck.
    ...
    python data/reports/fxy_gate_eval_arm2_20260829.py
"""
...
OUT = ROOT / "data/reports/fxy_gate_eval_arm2b_20260829.json"
