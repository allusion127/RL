"""G2/G3/G4 adjudication for the F_xy prior-residual head (prereg
``data/reports/fxy_head_prereg_20260829.md`` + Amendment A).
...
nothing, edits no deck.
    ...
    python data/reports/fxy_gate_eval_20260829.py
"""
...
CAND = ROOT / "data/models/20260829_135208"
PREV = ROOT / "data/models/s1i"
STORE = ROOT / "data/store"
SPLIT = ROOT / "data/splits/S1j.json"
OUT = ROOT / "data/reports/fxy_gate_eval_20260829.json"
...
def main() -> int:
    ...
    prev = _load(PREV)
    yard = {}
    p_new = cand.predict(pats, cases)
    p_old = prev.predict(pats, cases)
