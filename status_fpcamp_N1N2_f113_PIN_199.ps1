# status_fpcamp_N1N2_f113_PIN_199.ps1 -- READ-ONLY status probe for the
# N1_N2/f113 pin-gated re-campaign. Emits a machine-parsable block; starts
# nothing.
#   ssh USER@HOST_199 "powershell -NoProfile -ExecutionPolicy Bypass -File C:\Users\USER\lpopt_work\kit_frontier\status_fpcamp_N1N2_f113_PIN_199.ps1"
$ErrorActionPreference = 'SilentlyContinue'
$k   = 'C:\Users\USER\lpopt_work\kit_frontier'
$r   = Join-Path $k 'runs\fpcamp_minfr_N1N2_f113_pin'
$log = Join-Path $k 'fpcamp_minfr_N1N2_f113_pin_out.log'
$rcf = Join-Path $k 'fpcamp_minfr_N1N2_f113_pin_rc.txt'
